...
export const metadata = { title: "Problem Waybill Stuck" };
...
export default async function WaybillStuckDeliveryPage() {
  ...
  return <AppShell session={session}>
    {session.outletId
      ...
      : <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-amber-900">Pilih outlet aktif sebelum membuka Problem Waybill Stuck.</div>}
  </AppShell>;
}
