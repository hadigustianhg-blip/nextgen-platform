...
import { attendanceErrorResponse, attendanceLocationInputSchema, clockOut } from "@/modules/attendance";
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ success: true, data: await clockOut(context, parsed.data) });
  }
