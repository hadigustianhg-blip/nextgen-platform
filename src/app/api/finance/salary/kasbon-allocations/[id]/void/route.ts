...
import {
  ...
  salaryAdjustmentVoidSchema,
  salaryErrorResponse,
  salaryScope,
  voidSalaryKasbonAllocation,
} from "@/modules/salary";
...
export async function POST(request: Request, context: Context) {
  ...
  const parsed = salaryAdjustmentVoidSchema.safeParse(
  ...
  try {
    return NextResponse.json({ data: await voidSalaryKasbonAllocation({
      ...scope,
