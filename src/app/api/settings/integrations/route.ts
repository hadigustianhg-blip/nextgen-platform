...
import { resolveJfsHelperDistribution } from "@/modules/integrations/jfs-helper-distribution";
...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...data,
        jfsWaybillHelper: distribution
          ? { available: true, version: manifest.version, badge: distribution.badge }
          : undefined,
      },
