...
export const invoiceDraftSchema = z.object({
  ...
  transferBankName: z.string().trim().max(100).nullable().optional(),
  transferAccountNumber: z.string().trim().max(100).nullable().optional(),
  transferAccountHolder: z.string().trim().max(200).nullable().optional(),
