...
const safeMessages: Record<string, string> = {
  ...
  WAYBILL_NOT_ACCESSIBLE: "Nomor resi tidak dapat digunakan.",
  PAYMENT_ACCOUNT_NOT_ACCESSIBLE: "Rekening penerima pembayaran tidak dapat digunakan.",
  PAYMENT_ACCOUNT_REQUIRED: "Rekening penerima pembayaran belum dikonfigurasi.",
