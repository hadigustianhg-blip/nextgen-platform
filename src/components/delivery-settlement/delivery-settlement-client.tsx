...
type Summary = {
  ...
  totalDfod: string; courierCount: number;
  clearCount: number; unclearedCount: number; overpaidCount: number;
};

const emptySummary: Summary = { totalSettlement: "0", totalCashReceived: "0", totalTransferReceived: "0", totalOutstanding: "0", totalCod: "0", totalCodCash: "0", totalCodQris: "0", totalDfod: "0", courierCount: 0, clearCount: 0, unclearedCount: 0, overpaidCount: 0 };
