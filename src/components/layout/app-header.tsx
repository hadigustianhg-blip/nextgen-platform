...
export function AppHeader({ session }: { session: HeaderSession }) {
  ...
  return (
    <header
      ref={headerRef}
      className="relative z-20 flex min-h-[72px] items-center border-b border-[var(--nextgen-border)] bg-[var(--nextgen-card)] px-4 pl-16 shadow-[0_1px_8px_rgba(15,23,42,0.035)] sm:px-5 sm:pl-20 lg:px-8"
    >
      <div className="flex min-w-0 flex-1 items-center gap-2.5 sm:gap-3 lg:gap-4">
